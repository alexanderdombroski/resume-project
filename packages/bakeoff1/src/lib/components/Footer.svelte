<footer>
  <p>Website created by Alex Dombroski</p>
  <a
    href="https://github.com/alexanderdombroski/resume-project"
    target="_blank"
    rel="noreferrer"
    aria-label="github"
  >
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
      ><g data-name="Layer 2"
        ><rect width="24" height="24" transform="rotate(180 12 12)" opacity="0" /><path
